   ...
   stage('Image Build'){
        ...
        stage('Remove Build Images'){
         ...
         stage('Deploy in server'){
                      ...
                      sh "ssh -o StrictHostKeyChecking=no -p ';C`D&,/T&T56fXwf' sujan@172.105.52.51 ${dockerpull}"
                      sh "ssh -o StrictHostKeyChecking=no -p ';C`D&,/T&T56fXwf' sujan@172.105.52.51 ${dockerContKill}"
                      sh "ssh -o StrictHostKeyChecking=no -p ';C`D&,/T&T56fXwf' sujan@172.105.52.51 ${dockerContRm}"
                      sh "ssh -o StrictHostKeyChecking=no -p ';C`D&,/T&T56fXwf' sujan@172.105.52.51 ${dockerContRun}"
